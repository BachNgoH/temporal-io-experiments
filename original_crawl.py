...
class DirectAPICrawler:
    ...
    def __init__(self, page: Page, extraction_folder: str, session_cookies=None, session_headers=None):
        self.page = page
    ...
    async def download_files_for_invoices(
        ...
        logger.info(f"🚀 Executing {len(all_tasks)} invoice downloads in PARALLEL using asyncio.gather()...")
